...
public:
    ...
    virtual GpioAbstract::Error configure(int port, int line, Type type) = 0;
    virtual GpioAbstract::Error set(int port, int line, int value) = 0;
    virtual GpioAbstract::Error get(int port, int line, int *value) = 0;
